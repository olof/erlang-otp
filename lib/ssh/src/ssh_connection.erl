...
handle_msg(#ssh_msg_channel_window_adjust{recipient_channel = ChannelId,
    ...
    case ssh_client_channel:cache_lookup(Cache, ChannelId) of
        #channel{remote_id = RemoteId, send_window_size=Size} = Channel0 ->
            {SendList, Channel} = update_send_window(
                Channel0#channel{send_window_size = Size + Add},
                0,  %% TODO: Datatype 0 ?
        ...
        undefined -> %% Channel has already been closed, ignoring message
            {[], Connection}
    end;
